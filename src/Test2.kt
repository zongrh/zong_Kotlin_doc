...
//    虽然经历了装箱，但是值相等的，都是1000
    println(boxedA === anotherBoxedA)//false值相等，但是对象地址不一样
...
//用来表示各个类型的数组，省去了装箱操作，因此效率更高，其用法同Array一样：
fun main2_5() {
